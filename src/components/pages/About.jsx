...
const About = () => {
  return (
    <div className="jumbo">
      ...
      {/* <section className="section about4" id="about4">
        <div className="manifiesto">
          <h5>Nuestro manifiesto:</h5>
          <ul>
            <li>
        ...
        <div className="foto-manifiesto">
          <img
            className="foto"
            src="../../../public/img/periodico.jpg"
            alt="Mujer leyendo el periódico"
          />
        </div>
      </section> */}
